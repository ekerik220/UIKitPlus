...
//
    ...
    public protocol LifecycleBuilderProtocol: AnyObject, AppBuilderContent {
        ...
        func willChangeStatusBarOrientation(_ handler: @escaping (
            _ newOrientation: UIInterfaceOrientation,
        ...
        func handleLocalActionWithResponseInfo(_ handler: @escaping (
            _ identifier: String?,
            _ notification: UILocalNotification,
            _ responseInfo: [AnyHashable: Any],
            _ completionHandler: @escaping () -> Void
        ) -> Void) -> Self
        func handleLocalAction(_ handler: @escaping (
            _ identifier: String?,
            _ notification: UILocalNotification,
            _ completionHandler: @escaping () -> Void
        ) -> Void) -> Self
        func handleRemoteActionWithResponseInfo(_ handler: @escaping (
            _ identifier: String?,
            _ remoteNotification: [AnyHashable: Any],
            _ responseInfo: [AnyHashable: Any],
            _ completionHandler: @escaping () -> Void
        ) -> Void) -> Self
        func handleRemoteAction(_ handler: @escaping (
            _ identifier: String?,
            _ remoteNotification: [AnyHashable: Any],
            _ completionHandler: @escaping () -> Void
        ) -> Void) -> Self
        func didReceiveRemoteNotification(_ handler: @escaping (
        ...
        func performActionForShortcutItem(_ handler: @escaping (
            _ shortcutItem: UIApplicationShortcutItem,
            _ completionHandler: @escaping (Bool) -> Void
        ) -> Void) -> Self
        func handleEventsForBackgroundURLSession(_ handler: @escaping (
            _ identifier: String,
            _ completionHandler: @escaping () -> Void
        ) -> Void) -> Self
        func handleWatchKitExtensionRequest(_ handler: @escaping (
            _ userInfo: [AnyHashable: Any],
            _ reply: @escaping ([AnyHashable: Any]?) -> Void
        ) -> Void) -> Self
        ...
        func viewControllerWithRestorationIdentifierPath(_ handler: @escaping (
            _ identifierComponents: [String],
            _ coder: NSCoder
        ...
        func continueUserActivity(_ handler: @escaping (
            _ userActivity: NSUserActivity,
            _ restorationHandler: @escaping ([UIUserActivityRestoring]?) -> Void
        ) -> Bool) -> Self
    ...
    public extension LifecycleBuilderProtocol {
        var appBuilderContent: AppBuilderItem { .lifecycle(self) }
    }
    ...
    protocol _LifecycleBuilderProtocol: LifecycleBuilderProtocol {
        ...
        var _didReceiveRemoteNotificationWithCompletion: ((
            [AnyHashable: Any],
    ...
    class LifecycleBuilder: _LifecycleBuilderProtocol {
        ...
        public func willChangeStatusBarOrientation(_ handler: @escaping (
            _ newOrientation: UIInterfaceOrientation,
            _ duration: TimeInterval
        ) -> Void) -> Self {
        ...
        public func handleLocalActionWithResponseInfo(_ handler: @escaping (
            _ identifier: String?,
            _ notification: UILocalNotification,
            _ responseInfo: [AnyHashable: Any],
            _ completionHandler: @escaping () -> Void
        ...
        public func handleLocalAction(_ handler: @escaping (
            _ identifier: String?,
            _ notification: UILocalNotification,
            _ completionHandler: @escaping () -> Void
        ) -> Void) -> Self {
        ...
        public func handleRemoteActionWithResponseInfo(_ handler: @escaping (
            _ identifier: String?,
            _ remoteNotification: [AnyHashable: Any],
            _ responseInfo: [AnyHashable: Any],
            _ completionHandler: @escaping () -> Void
        ...
        public func handleRemoteAction(_ handler: @escaping (
            _ identifier: String?,
            _ remoteNotification: [AnyHashable: Any],
            _ completionHandler: @escaping () -> Void
        ) -> Void) -> Self {
        ...
        public func didReceiveRemoteNotification(_ handler: @escaping (
            _ userInfo: [AnyHashable: Any],
            _ completionHandler: (UIBackgroundFetchResult) -> Void
        ) -> Void) -> Self {
        ...
        public func performActionForShortcutItem(_ handler: @escaping (
            _ shortcutItem: UIApplicationShortcutItem,
            _ completionHandler: @escaping (Bool) -> Void
        ) -> Void) -> Self {
        ...
        public func handleEventsForBackgroundURLSession(_ handler: @escaping (
            _ identifier: String,
            _ completionHandler: @escaping () -> Void
        ) -> Void) -> Self {
        ...
        public func handleWatchKitExtensionRequest(_ handler: @escaping (
            _ userInfo: [AnyHashable: Any],
            _ reply: @escaping ([AnyHashable: Any]?) -> Void
        ) -> Void) -> Self {
...
//    }
        ...
        public func viewControllerWithRestorationIdentifierPath(_ handler: @escaping (
            _ identifierComponents: [String],
            _ coder: NSCoder
        ) -> UIViewController?) -> Self {
        ...
        public func continueUserActivity(_ handler: @escaping (
            _ userActivity: NSUserActivity,
            _ restorationHandler: @escaping ([UIUserActivityRestoring]?) -> Void
        ) -> Bool) -> Self {
        ...
        public func didFailToContinueUserActivityWithType(_ handler: @escaping (
            _ userActivityType: String,
            _ error: Error
        ) -> Void) -> Self {
