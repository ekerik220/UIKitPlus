...
//
    ...
    public extension AnyScene {
        ...
        func onBecomeActive(_ handler: @escaping () -> Void) -> Self {
        ...
        func onWillResignActive(_ handler: @escaping () -> Void) -> Self {
        ...
        func onWillEnterForeground(_ handler: @escaping () -> Void) -> Self {
        ...
        func onDidEnterBackground(_ handler: @escaping () -> Void) -> Self {
