...
public class ParagraphStyle: NSMutableParagraphStyle {
    ...
    override public func setParagraphStyle(_ obj: NSParagraphStyle) {
    ...
    override public var lineSpacing: CGFloat {
    ...
    override public var paragraphSpacing: CGFloat {
    ...
    override public var firstLineHeadIndent: CGFloat {
    ...
    override public var headIndent: CGFloat {
    ...
    override public var tailIndent: CGFloat {
    ...
    override public var minimumLineHeight: CGFloat {
    ...
    override public var maximumLineHeight: CGFloat {
    ...
    override public var lineHeightMultiple: CGFloat {
    ...
    override public var defaultTabInterval: CGFloat {
    ...
    override public var paragraphSpacingBefore: CGFloat {
    ...
    override public var hyphenationFactor: Float {
    ...
    public func hyphenationFactor(_ state: State<Float>) -> Self {
        ...
        override public var tighteningFactorForTruncation: Float {
        ...
        override public var headerLevel: Int {
        ...
        override public var allowsDefaultTighteningForTruncation: Bool {
    ...
    override public var baseWritingDirection: NSWritingDirection {
    ...
    override public var tabStops: [NSTextTab]! {
        get { super.tabStops }
        set {
    ...
    public func tabStops(_ state: State<[NSTextTab]>) -> Self {
        ...
        override public var textBlocks: [NSTextBlock] {
        ...
        override public var textLists: [NSTextList] {
            get { super.textLists }
            set {
